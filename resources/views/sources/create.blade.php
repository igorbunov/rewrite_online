...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">{{ __('Новый источник текста') }}</div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('projects.sources.store', $project) }}">
                        @csrf
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name', 'Источник') }}" required autocomplete="false">
